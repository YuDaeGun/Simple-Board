...
create sequence member4_seq start with 1 maxvalue 999999999 increment by 1 nocycle nocache;
create sequence board2_seq start with 1 maxvalue 999999999 increment by 1 nocycle nocache;
create sequence reply_seq start with 1 maxvalue 999999999 increment by 1 nocache nocycle;
...
create table board2 (
	...
	constraint board2_member4_fk foreign key(writer) references member4(userid) on delete cascade
);

create table reply (
	idx		    number		    default reply_seq.nextval primary key,
	boardIdx	number		    not null,	-- board2.idx
	writer		varchar2(100)	not null,	-- member4.userid
	content		varchar2(1000)	not null,
	writeDate	date		    default sysdate,

	constraint reply_board_fk foreign key(boardIdx) references board2(idx),
	constraint reply_member_fk foreign key(writer) references member4(userid)
);
